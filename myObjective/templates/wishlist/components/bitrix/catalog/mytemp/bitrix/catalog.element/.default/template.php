...
$arItemIDs = array(
	...
	'ADD_TO_WISHLIST' => $strMainID.'_add_to_wishlist_link',
);
...
?>
	...
	<a href="javascript:void(0);" class="bx_big bx_bt_button bx_wishlist" id="<? echo $arItemIDs['ADD_TO_WISHLIST']; ?>"><span>Добавить в список желаний</span></a>
	</div>
<?
